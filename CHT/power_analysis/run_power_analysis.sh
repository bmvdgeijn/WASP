...
# run simulation
Rscript --vanilla $WASP_DIR/CHT/sim_haplotype_read_counts.R \
...
python $WASP_DIR/CHT/fit_bnb_coefficients.py --no_sample $OUT_DIR/input_files.txt $OUT_DIR/bnb_coef.txt
