...
1.  SNP chromosome
2.  SNP position
3.  Chi-square test statistic (one degree of freedom)
4.  ML estimate of alpha parameter (expected reads from reference chromosome)
5.  ML estimate of beta parameter (expected reads from alternate chromosome)
6.  ML estimate of BNB dispersion parameter for region
7.  total count of allele-specific reads for this target region
8.  total count of reads for this target region
