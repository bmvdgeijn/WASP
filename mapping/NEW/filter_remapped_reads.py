...
def parse_options():
    parser = argparse.ArgumentParser(description="This program checks "
                                     ...
                                     "variants. These read names are "
                                     "generated by the "
                                     "find_intersecting_snps.py script.")
    
    parser.add_argument("to_remap_bam", help="BAM file containing "
                        ...
                        "script.")
    parser.add_argument("remap_bam", help="BAM file containing "
                        "remapped reads (with flipped alleles)")
    parser.add_argument("keep_bam", help="new BAM file to write "
                        "filtered reads to")
