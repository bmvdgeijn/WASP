...
ls test_data/H3K27ac/haplotype_read_counts*.adjusted.hetp.txt.gz > $CHT_IN_FILE
...
#
OUT_FILE=test_data/H3K27ac/cht_results.txt
python CHT/combined_test.py --min_as_counts 10 \
       --bnb_disp test_data/H3K27ac/cht_bnb_coef.txt \
       --as_disp test_data/H3K27ac/cht_as_coef.txt \
